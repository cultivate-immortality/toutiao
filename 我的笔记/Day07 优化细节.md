...
1. vant 组件库里有个叫 LazyLoad 指令, 在 main.js 中全局注册
...
3. 监测 tabs 切换后, 从 nameToTop 对象里拿到原本滚动位置设置
