...
2. 在 Login/index.vue 使用组件, 定义变量, 和表单校验
...
一定要重启 vscode 和 webpack 开发服务器才会生效
...
3. 在 Login/index.vue 调用 actions 方法, 发送登录请求
...
3. 再次重新登录, 观察 vuex 和本地是否有值, 就代表成功
